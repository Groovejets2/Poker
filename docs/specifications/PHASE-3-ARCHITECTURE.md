...
**Purpose:** Define technology choices, API design, database schema, and deployment architecture for the website platform (Phase 3)

**Status:** active
**Version:** 1.0
**Last Updated:** 2026-02-22 11:52 GMT+13
**Owner:** Jon + Angus
**Related Documents:** [DEPLOYMENT_ARCHITECTURE.md](../DEPLOYMENT_ARCHITECTURE.md), [DATABASE-SCHEMA.md](DATABASE-SCHEMA.md), [API-SCHEMA.md](API-SCHEMA.md)
...
|------|---------|--------|--------|
| 2026-02-22 11:52 | 1.0 | Angus | Added metadata and change log per DOCUMENTATION_STANDARDS.md; renamed from 2026-02-21_phase-3-architecture_v1.0.md |
| 2026-02-21 10:06 | 1.0 | Angus | Initial creation with tech stack, API design, database schema, architecture overview |
...
| ORM | TypeORM or Sequelize | Database-agnostic, migrations, type safety |
...
└──────────────┬──────────────────────────────────────┘
               │ SQL (via ORM)
┌──────────────▼──────────────────────────────────────┐
│    Database (SQLite for test / PostgreSQL for prod) │
│    - users                                          │
│    - tournaments                                    │
│    - tournament_players                             │
│    - matches                                        │
...
### API ↔ Database
- ORM: TypeORM or Sequelize (database-agnostic)
- **Migrations:** Managed via ORM CLI
...
3. **Proceed to 3.3:** Backend implementation (Express API + database, with ORM for test/prod portability)
